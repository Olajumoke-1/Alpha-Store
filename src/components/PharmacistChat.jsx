...
function PharmacistChat() {
  ...
  <div class="mx-auto max-w-7xl px-6 text-center lg:px-8">
    <div class="mx-auto max-w-2xl">
      ...
      <p class="mt-4 text-lg leading-8 text-gray-600">We’re a dynamic group of individuals who are passionate about what we do. Using any of our contacts here you can reach out to any of us with complaints and enquiries</p>
    </div>
